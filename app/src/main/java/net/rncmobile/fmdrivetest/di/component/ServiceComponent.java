...
import net.rncmobile.fmdrivetest.di.PerService;
import net.rncmobile.fmdrivetest.di.module.ServiceModule;
...
public interface ServiceComponent {
    ...
    void inject(FMDService service);

    void inject(PhoneStateJobService service);
}
